...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Time of contract launch (2020-24-9T00:00:00Z) */
    uint256 internal constant LAUNCH_TIME = 1600987200;
    ...
    /* reduce amount of tokens to 500000 */
        ...
        external
    {
        ...
        require(g._currentDay > CLAIM_PHASE_START_DAY, "TIME: Too early");

        if (beforeDay != 0) {
            require(beforeDay <= g._currentDay, "TIME: beforeDay cannot be in the future");
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "TIME: range invalid");
        ...
        view
    {
        ...
        require(stakeIdParam == stRef.stakeId, "TIME: stakeIdParam not in stake");
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "TIME: newStakedDays lower than minimum");
        ...
        external
    {
        ...
        require(stakeLists[stakerAddr].length != 0, "TIME: Empty stake list");
        require(stakeIndex < stakeLists[stakerAddr].length, "TIME: stakeIndex invalid");
        ...
        require(g._currentDay >= st._lockedDay + st._stakedDays, "TIME: Stake not fully served");

        /* Stake must still be locked */
        require(st._unlockedDay == 0, "TIME: Stake already unlocked");
        ...
        external
    {
        ...
        /* require() is more informative than the default assert() */
        require(stakeListRef.length != 0, "TIME: Empty stake list");
        require(stakeIndex < stakeListRef.length, "TIME: stakeIndex invalid");
        ...
        internal
    {
        ...
        require(newStakedDays <= MAX_STAKE_DAYS, "TIME: newStakedDays higher than maximum");
        ...
        require(newStakeShares != 0, "TIME: newStakedSuns must be at least minimum shareRate");
        ...
        returns (uint256 bonusSuns)
    {
        /*
            ...
            Bonus percentage scaled 0% to 10% for the first 7M TIME of stake.
...
contract TransformableToken is StakeableToken {
        ...
        payable
    {
        ...
        require(rawAmount != 0, "TIME: Amount required");
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count)
        external
    {
        require(enterDay < _currentDay(), "TIME: Round is not complete");
        ...
        if (count != 0) {
            require(count <= qRef.tailIndex - headIndex, "TIME: count invalid");
            endIndex = headIndex + count;
        } else {
            endIndex = qRef.tailIndex;
            require(headIndex < endIndex, "TIME: count invalid");
        }
        ...
        external
    {
        ...
        require(address(this).balance != 0, "TIME: No value");

        require(LAST_FLUSHED_DAY < _currentDay(), "TIME: Invalid day");
        ...
        returns (uint256 rawAmount, address referrerAddr)
    {
        ...
        require(entry.rawAmount != 0, "TIME: Param invalid");
    ...
    {
        /* 1095890410958 = ~ 4000000 * SUNS_PER_DIV / 365 */
...
contract TIME is TransformableToken {
    constructor()
        public
    {
